...
COLUMNS: Final = {
    ...
    'capacity': Column(title='Capacity', prop='capacity', right_align=True, color=color_optional),
    'allocated': Column(title='Allocated', prop='allocated', right_align=True, color=color_optional),
    'available': Column(title='Available', prop='available', right_align=True, color=color_optional),
